...
import { findAllEditoras, findEditoraByName } from '../../Service/EditoraService';
...
const ListarEditora = () => {
    ...
    useEffect( () => {
        async function loadDataByName(){
            const data = await findEditoraByName(nome, page, pageSize, dir, props);
            //console.log(data);
            setPage(data.currentPage);
            setPageSize(data.pageSize);
            setTotal(data.lastPage);
    ...
    return(
      <Fragment>
        ...
        <div className='container'>
          ...
          <GradeSistema>
              <div className='row'>
                <SelectNumberPages pageSize={pageSize}
